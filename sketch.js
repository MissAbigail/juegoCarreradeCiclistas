...
function draw() {
  ...
  textSize(20);
  text("¡Presiona la tecla de Flecha hacia Arriba para reinicar el juego!", 75,200);
...
function pinkCyclists(){
        ...
        pinkCG.add(player1);
        player1.setCollider("rectangle",0,0,1100,1100);
}
...
function yellowCyclists(){
        ...
        player2.setCollider("rectangle",0,0,1100,1100);
}
...
function redCyclists(){
        ...
        redCG.add(player3);
        player3.setCollider("rectangle",0,0,1100,1100);
}
